...
const blogPostsSource = [
  ...
  { slug: 'offshore-legal-virtual-receptionist-intake', title: 'Offshore legal virtual receptionist intake workflow', excerpt: 'Design a careful receptionist lane for calls, facts, appointments, and fast escalation to the firm.', minutes: 8 },
  { slug: 'law-firm-offshore-support-service-levels', title: 'Service levels for offshore law firm support', excerpt: 'Set practical response windows and ownership rules without promising outcomes a support role cannot control.', minutes: 7 },
  { slug: 'offshore-legal-support-confidentiality-checklist', title: 'Confidentiality checklist for offshore legal support', excerpt: 'Turn confidentiality expectations into access, handling, communication, and review steps a team can follow.', minutes: 8 },
  { slug: 'legal-offshore-support-work-queue-design', title: 'How to design an offshore legal support work queue', excerpt: 'Build a visible queue with inputs, priority labels, owners, due dates, and exception paths.', minutes: 8 },
  { slug: 'offshore-legal-support-client-communications', title: 'Client communication boundaries for offshore legal support', excerpt: 'Define what support staff may acknowledge, collect, schedule, and route while attorneys retain advice and promises.', minutes: 8 },
  { slug: 'law-firm-offshore-support-document-review-prep', title: 'Document review preparation with offshore legal support', excerpt: 'Organize files, labels, and checklists before attorney review while keeping privilege and conclusions with counsel.', minutes: 9 },
  { slug: 'offshore-legal-support-matter-intake-form', title: 'An offshore legal matter intake form that works', excerpt: 'Capture the facts, tools, review owner, and escalation rules needed to start a support role safely.', minutes: 7 },
  { slug: 'legal-support-offshore-attorney-review-gates', title: 'Attorney review gates for offshore legal support', excerpt: 'Place review points where factual preparation becomes legal judgment, client communication, or final release.', minutes: 8 },
  { slug: 'offshore-legal-support-work-sample-test', title: 'How to build an offshore legal support work sample test', excerpt: 'Use redacted examples and a short scorecard to test accuracy, judgment boundaries, and escalation behavior.', minutes: 8 },
  { slug: 'law-firm-offshore-support-data-retention', title: 'Data retention planning for offshore law firm support', excerpt: 'Document what the role stores, where it lives, who owns retention, and how access ends.', minutes: 8 },
  { slug: 'offshore-legal-support-practice-area-pilot', title: 'Choosing a practice area for an offshore legal support pilot', excerpt: 'Choose a repeatable first lane by weighing volume, examples, review capacity, sensitivity, and measurable outcomes.', minutes: 8 },
  { slug: 'legal-offshore-support-holiday-handover', title: 'A holiday handover plan for offshore legal support', excerpt: 'Keep queues, contacts, urgent items, and approval boundaries clear when normal coverage changes.', minutes: 7 },
  { slug: 'offshore-legal-support-error-log', title: 'How to use an offshore legal support error log', excerpt: 'Make recurring misses visible, assign fixes, and separate coaching issues from process defects.', minutes: 7 },
  { slug: 'law-firm-offshore-support-weekly-report', title: 'What belongs in a weekly offshore legal support report', excerpt: 'Report output, quality samples, open exceptions, rework, and decisions needed from the firm.', minutes: 7 },
  { slug: 'offshore-legal-support-access-offboarding', title: 'Offboarding access for offshore legal support roles', excerpt: 'Close accounts, transfer work, preserve required records, and confirm that shared credentials are not left behind.', minutes: 8 },
  { slug: 'legal-support-offshore-call-escalation', title: 'Call escalation rules for offshore legal support', excerpt: 'Give intake and receptionist roles simple signals for urgency, sensitivity, complaints, and attorney review.', minutes: 7 },
  { slug: 'offshore-legal-support-workflow-documentation', title: 'Documenting an offshore legal support workflow', excerpt: 'Write instructions around inputs, actions, examples, stop rules, reviewers, and a clear done state.', minutes: 8 },
  { slug: 'law-firm-offshore-support-capacity-planning', title: 'Capacity planning for offshore law firm support', excerpt: 'Match queue volume and review capacity before adding tasks, hours, or matters to a remote role.', minutes: 8 },
  { slug: 'offshore-legal-support-quality-calibration', title: 'Quality calibration for offshore legal support teams', excerpt: 'Use shared examples and short review sessions to align the worker, manager, and firm quality bar.', minutes: 7 },
  { slug: 'legal-offshore-support-vendor-transition', title: 'Transitioning legal support work to an offshore team', excerpt: 'Move one workflow with an inventory, shadow period, controlled access, and an explicit rollback plan.', minutes: 9 },
