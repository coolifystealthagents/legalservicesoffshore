    ...
    <section className="hero-shell">
      ...
      <div className="hero-grid">
        <div className="hero-copy">
          <p className="eyebrow">HR policy desk</p>
          <h1>Legal Services Offshore: a compliance desk for clearer staffing decisions.</h1>
          <p className="lead">A redesigned legal services offshore guide for law firms and legal teams outsourcing support work safely. The page now uses a distinct compact procedural layout, industry-specific planning sections, and a conversion path that feels made for this niche.</p>
        ...
        <figure className="hero-media"><img src={site.heroImage || site.serviceImage} alt={site.alt || `${site.brand} planning visual`}/><figcaption>tabs, stamps, and policy boxes</figcaption></figure>
      </div>
    </section>
