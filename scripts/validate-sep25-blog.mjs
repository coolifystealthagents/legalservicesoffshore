...
const source=await readFile('app/blog/blog-2026-09-25.ts','utf8');
...
assert.match(data,/\.\.\.september25BlogPosts/);
...
console.log('September 25 Blog: PASS (12 new articles, 900+ words, sources, canonical, datePublished, sitemap wiring)');
