...
const source=await readFile('app/blog/blog-2026-09-22.ts','utf8');
...
assert.match(data,/\.\.\.september22BlogPosts/);
...
console.log('September 22 Blog: PASS (12 new articles, 900+ words, sources, canonical, datePublished, sitemap wiring)');
